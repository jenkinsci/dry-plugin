...
public class ResultSummaryTest extends AbstractEnglishLocaleTest {
    ...
    public void test0WarningsIn0File() {
        checkSummaryText(0, 0, ": 0 warnings from 0 analyses.");
    }
    ...
    public void test1WarningIn2analyses() {
        checkSummaryText(1, 2, ": <a href=\"dryResult\">1 warning</a> from 2 analyses.");
    }
    ...
    public void test5WarningsIn1File() {
        checkSummaryText(5, 1, ": <a href=\"dryResult\">5 warnings</a> from one analysis.");
    }
